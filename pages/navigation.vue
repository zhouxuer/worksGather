<template>
  <div class="VueToNuxtLogo">
    <div id="startscreen">
      ...
      <button id="button" @click="butClick">⟷</button>
    </div>

    <div id="menuContent">
      <ul>
          <li><a rel="nofollow" href=".section1">Menu 1</a>
          </li>
          <li><a rel="nofollow" href=".section2">Menu 2</a>
          </li>
          <li><a rel="nofollow" href=".section3">Menu 3</a>
          </li>
      </ul>
